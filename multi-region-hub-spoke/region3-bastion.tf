...
resource "azurerm_subnet" "subnet_bastion_region3" {
  name                                          = "AzureBastionSubnet"
  resource_group_name                           = module.resource_group_hub_region3.resource_group_name
  address_prefixes                              = [cidrsubnet(var.vnet_hub_region3_address_space, 6, 2)]
...
// Azure Bastion 
module "bastion_region3" {
  source              = "../modules/azure-bastion"
  bastion_subnet_id   = azurerm_subnet.subnet_bastion_region3.id
